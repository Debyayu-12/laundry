...
class Konsumen extends CI_Controller {
    ...
    public function simpan()
    {
        ...
        if ($query = true) {
            $this->session->set_flashdata('info', 'Data Konsumen Brhasil di Simpan');
        }
        redirect('konsumen');
    }
    ...
    public function update()
    {
        ...
        if ($query = true) {
            $this->session->set_flashdata('info', 'Data Konsumen Brhasil di Update');
        }
        redirect('konsumen');
    }
    ...
    public function delete($id)
    {
        ...
        if ($query = true) {
            $this->session->set_flashdata('info', 'Data Konsumen Brhasil di Delete');
        }
        redirect('konsumen');
    }
}
